...
async function multisigcontrol_set_threshold(
  ...
  return await multisigcontrol_instance.methods
...
async function erc20_asset_pool_set_bridge_address(
  ...
  return await erc20_asset_pool_instance.set_bridge_address(
    bridge_address,
    ms.nonce,
    ms.sigs
  );
...
async function go() {
  ...
  // let stagnet1_erc20_bridge_logic1_address = "0xb4E6cF254B61332BC93ffE96bD836561F7D8F37c";
  // let erc20_bridge_logic1_instance = await load_contract(
  //   w3,
  //   "ERC20_Bridge_Logic",
  //   stagnet1_erc20_bridge_logic1_address,
  // );
  // let real_validators = [
  //   Buffer.from(
  //     "5b569f098b150a70a1dbe3603d54560bda4d0c22e5754977d21e35e12c5bcf62",
  //     "hex"
  //   ),
  //   Buffer.from(
  //     "577d78eb8da82145b0fbbb193045d94c91abc0b94ca5ea7407aa4713fe33a8f9",
  //     "hex"
  //   ),
  //   Buffer.from(
  //     "17b1a04d2f8295843f1b29f07534be55fa15723554574f34b1a2ae38f380fde8",
  //     "hex"
  //   ),
  //   Buffer.from(
  //     "17b1a04d2f8295843f1b29f07534be55fa15723554574f34b1a2ae38f380fde8",
  ...
  //   ),
  // ];
  // let stagnet1_vega_token_address = "0x45984C4E9F3D55325fc6Fd2E260881EE3Ce9bbCD";
  // let result = await erc20_bridge_logic1_instance.methods
  //   .is_asset_listed(stagnet1_vega_token_address).call();
  // if (result === true) {
  //   console.log(`erc20_bridge: asset ${stagnet1_vega_token_address} already listed`);
  // } else {
  //   await erc20_bridge_list_asset(
  //     erc20_bridge_logic1_instance,
  //     stagnet1_vega_token_address,
  ...
  //   },
  //   {
  //     name: "Vega V1 (ZZZnet) (do not use)",
  //     symbol: "VEGAv1",
  //     decimals: 18,
  //     total_supply_whole_tokens: "64999723",
  //     faucet_amount: (1e18).toString(),
  ...
  // //   await multisigcontrol_add_signer(
  // //     multisigcontrol_instance,
  // //     validators[i],
  // //     accounts[0],
  // //     initial_validators
  ...
  // // await multisigcontrol_remove_signer(
  // //   multisigcontrol_instance,
  // //   accounts[0],
  // //   accounts[0],
  // //   initial_validators
  ...
  //   "ERC20_Vesting",
  //   accounts[0],
  //   [addresses.VEGAv1, addresses.VEGA, [], []]
  // );
